...
\begin{figure*}[!thb]
  \centering
  \subfigure[Design Debt]{\includegraphics[width=0.48\textwidth]{figures/chapter4/f1_measure_comparisom_design_1.pdf}
  \label{chap4:fig:f1_measure_comparison_design_debt}}
  \subfigure[Requirement Debt]{\includegraphics[width=0.48\textwidth]{figures/chapter4/f1_measure_comparisom_requirement_1.pdf}
...
\begin{figure*}[!thb]
    \centering
    \subfigure[Design Debt]{\includegraphics[width=0.49\textwidth]{figures/chapter4/ten_fold_validation_average_100_requirement.pdf}
    \label{chap4:fig:design_debt_per_comment_average}}
    \subfigure[Requirement Debt]{\includegraphics[width=0.49\textwidth]{figures/chapter4/ten_fold_validation_average_100_requirement.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width = 0.48\textwidth]{figures/chapter4/textual_similarity_removing_stop_words.pdf}
  \vspace{-3mm}
...
\begin{figure*}[!thb]
  \centering
  \subfigure[Design Debt]{\includegraphics[width=0.48\textwidth]{figures/chapter4/classifier_algorithms_comparison_design_1.pdf}
  \label{chap4:fig:algorithms_comparison_design}}
  \subfigure[Requirement Debt]{\includegraphics[width=0.48\textwidth]{figures/chapter4/classifier_algorithms_comparison_implementation_1.pdf}
